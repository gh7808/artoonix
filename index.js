...
//const opt6 = document.querySelector('#opt2');
...
.then((data)=>{
    ...
    opt3.textContent = data[counter].options[2];
    opt4.textContent = data[counter].options[3];
    opt5.textContent = data[counter].options[4];
    opt6.textContent = data[counter].options[5];
    opt7.textContent = data[counter].options[6];
    opt8.textContent = data[counter].options[7];
    opt9.textContent = data[counter].options[8];
    opt10.textContent = data[counter].options[9];
    option.forEach((opt)=>{
